...
class Inferer:
    ...
    def infer(
        ...
        for img_path in [img]:
            ...
            img, img_src = self.load_image_from_video(img_path, self.img_size, self.stride, self.half)
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    box.append([int(el.item()) for el in xyxy])
                    classes.append(class_num)
                    confidence_score.append(conf.item())
        ...
        return img_src, box, classes, confidence_score
    ...
    @staticmethod
    def load_image_from_video(img_src, img_size, stride, half):
        image = letterbox(img_src, img_size, stride=stride)[0]
    ...
    @staticmethod
    def font_check(font="action_tracking_API/yolov6/utils/Arial.ttf", size=10):
