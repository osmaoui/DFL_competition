...
class RepPANNeck(nn.Module):
    ...
    def __init__(self, channels_list=None, num_repeats=None):
        ...
        self.Rep_p3 = RepBlock(
            in_channels=channels_list[2] + channels_list[6], out_channels=channels_list[6], n=num_repeats[6]
        )
        ...
        self.Rep_n4 = RepBlock(
            in_channels=channels_list[5] + channels_list[9], out_channels=channels_list[10], n=num_repeats[8]
        )
